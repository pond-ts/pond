...
| `MultiSelector`             | `sequence?`, `onSelect?`, `onHover?`                                                                                                                                                                                                      | Sweep-select superset of `Selector`: drag sweeps marks, release reports `(hits, modifiers, span)` (RFC A5.2) | `packages/charts/src/selectors.tsx`                    |
