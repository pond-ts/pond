...
[Concepts → Triggers](../../pond-ts/concepts/triggers).
...
- [Concepts → Triggers](../../pond-ts/concepts/triggers) — the
  mental model
- [Concepts → Sequences](../../pond-ts/concepts/sequences) —
  what clock triggers consume
- [Concepts → Partitioning](../../pond-ts/concepts/partitioning)
