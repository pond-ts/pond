...
Boundaries that snap to local-calendar units (day / week / month) in a
chosen time zone. Use these when calendar boundaries matter — daily
reports, monthly aggregates, weekday-vs-weekend rollups.
