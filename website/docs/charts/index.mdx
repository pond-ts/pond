...
### Interop escape hatches & theming

With a pond series, the components above are the whole data contract — the
`from*` exports below are for hand-building views from **non-pond** data
only.

| Export                                                                                                  | What it is                                                                                                           |
| ------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| `fromTimeSeries`, `bandFromTimeSeries`, `boxFromTimeSeries`, `barsFromTimeSeries`, `ohlcFromTimeSeries` | Hand-build a layer view from non-pond data (with a pond series, pass it directly).                                   |
