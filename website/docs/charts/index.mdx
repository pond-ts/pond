...
:::note
The docs here are an introduction plus the generated type reference. A full
tutorial track (Learn charts) and a per-chart-type reference section are on
the roadmap — see [PLAN.md](https://github.com/pjm17971/pond-ts/blob/main/PLAN.md)'s
