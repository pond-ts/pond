...
| `ensemble` (16%) | 6.2                                 | 49.5          | **8.0×**   |

The pack still covers ~22% of the plot and its densest crossings reach 36 L\*,
so it is legible as texture — it just stops arguing. Dark mode lands at 7.3×
