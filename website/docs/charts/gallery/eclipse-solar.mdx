...
the pack's mean (at 17:00), and eclipse day itself rides _above_ baseline
...
Red Eléctrica had pre-announced a loss of _up to 5 GW_.

One more quirk worth reading off the chart: none of the four days ever
touches zero. Each enters the night around **0.5–0.65 GW** and drains to
**0.12–0.22 GW** before dawn — ENTSO-E reports concentrated solar plants
discharging stored heat after dark inside the same category as PV.
