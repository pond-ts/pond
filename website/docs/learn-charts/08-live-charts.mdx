...
import LearnLivePipeline from '@site/src/examples/learn-08-live-pipeline';
...
- Deriving many views (scatter, curve, bars) from one live stream with the
  batch operators you already know
...
<ChartExample name="learn-08-live-pipeline" height={340}>
  <LearnLivePipeline />
</ChartExample>
...
See the [@pond-ts/financial](../financial/) section for the calendar-aware
side of that shape.
